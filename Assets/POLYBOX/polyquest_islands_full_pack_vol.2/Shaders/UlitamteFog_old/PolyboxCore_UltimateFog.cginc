...
half _HeightFogStart2;
half _HeightFogEnd2;
half4 _HeightFogColor2;
sampler2D _HeightFogGradient;
half _HeightFogPow, _HeightFogPow2;
...
half4 fragForwardBaseInternal (VertexOutputForwardBase i)
{
	...
	heightFog = pow(heightFog,2.2*_HeightFogPow);
	half4 heightFogColor = unity_FogColor;

	#ifdef _HEIGHTFOGCOLOR
		heightFogColor = lerp(heightFogColor, _HeightFogColor, _HeightFogColor.a);
	#endif
	#ifdef _HEIGHTFOG2
		half heightFog2 = saturate((_HeightFogEnd2 - i.eyeVec.w) / (_HeightFogEnd2-_HeightFogStart2));
		heightFog2 = pow(heightFog2, 2.2*_HeightFogPow2);
		c.rgb = lerp(c.rgb, _HeightFogColor2, _HeightFogColor2.a * heightFog2);
	#elif _HEIGHTFOG2ADDITIVE
		half heightFog2 = saturate((_HeightFogEnd2 - i.eyeVec.w) / (_HeightFogEnd2-_HeightFogStart2));
		heightFog2 = pow(heightFog2, 2.2*_HeightFogPow2);
		heightFogColor.rgb = saturate(heightFogColor.rgb + _HeightFogColor2.rgb * _HeightFogColor2.a * heightFog2);
		heightFog = max(heightFog, _HeightFogColor2.a * heightFog2);
	#elif _HEIGHTFOGTEXTURE
		heightFogColor = tex2D(_HeightFogGradient, float2(0, (1 - heightFog)));
	#endif

	c.rgb = lerp(c.rgb, heightFogColor, heightFog);

	#ifdef _APPLYUNITYFOG
